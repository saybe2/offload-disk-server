...
export const config = {
  ...
  migrateV1Enabled: (process.env.MIGRATE_V1_ENABLED || "true") === "true",
  migrateV1BackoffMinutes: toNumber(process.env.MIGRATE_V1_BACKOFF_MIN, 30),
  migrateV1DeleteOldParts: (process.env.MIGRATE_V1_DELETE_OLD_PARTS || "true") === "true",
